...
const CreatePost = () => {
  ...
  //---- generateImg function for the generate button -----
  // NOTE: no need for a useEffect since it's a function that is being called onClick.
const generateImage = async () => {
  ...
  //---- handleChange function also for the form ----
  const handleChange = (e) => {
    setForm({...form, [e.target.name] : e.target.value})
  }

  //---- handleSurpriseMe function that'll give the user an extra button to generate random prompts -----
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          <button
          type='submit'
          className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm sm:w-auto px-5 py-2.5 text-center w-full"
          >
